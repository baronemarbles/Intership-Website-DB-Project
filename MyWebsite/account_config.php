    ...
    echo "<!DOCTYPE HTML>";
        echo "<html>";
            ...
            /*foreach ($account_info as $ai){*/
                ...
                echo "<label class='label' for='password'>Senha</label>";
                echo "<input type ='text' name='password' value='".htmlspecialchars($account_info["pw"])."' required>";
                echo "<button class='bttn'>Alterar</button>";
                echo "</form>";
